		...
		<div id="homewrapper">
			...
			<div id="homerow2">
				<div class="row2">
					...
					<div id="girl">
						<img width="200px" height="400px" src="images/girl2.png" />
					</div>
				</div>
				<div id="row3">
					<div id="row3col1">
...
@media (min-width: 1000px) {
	...
	#accounticon { 	width:4%;}
	.box {width: 15%;
		margin: 0px 0% 100px 20%;}
	.row2 {margin: 80px 0% 0px 15%;
		width: 60%;}
	#girl {width: 25%;
		margin: 60px 0% 0px 0%;}
	#row3{	margin: 0px 0% 0px 0%;}
